...
INSERT INTO user (active, email, doctor, name, password, phone_number, uses_sensor_sync_application_id) VALUES (1, 'john', 0, 'John Malkovich', 'john', '070 111 111', 1);
INSERT INTO user (active, email, doctor, name, password, phone_number, uses_sensor_sync_application_id) VALUES (1, 'bob', 1, 'Bob Dob', 'bob', '070 111 111', 1);
...
INSERT INTO treatment(treatment_from_date, patient_request, treatment_to_date, for_patient_id, has_doctor_id)
VALUES (CURRENT_TIMESTAMP , 'Request for blood test', CURRENT_TIMESTAMP, 1, 2);
